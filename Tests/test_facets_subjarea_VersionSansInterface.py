# This code works perfectly, but the graph. It generated the graph empty. I created another code 
# with the index 1 in order not to lose the reference of the good code. Whenever something goes
# wrong, I can always come back to this code.
...
if chart.series:
    for series in chart.series:
        if series is not None:  # ✅ Ensure series exists before modifying
            ...
            series.dLbls.showCatName = True  # ✅ Show subject area names under each bar
            ...
            series.dLbls.separator = "\n"  # ✅ Place name and value on separate lines
